...
//      we initialize a string of vowels to check against for our vowel upper-casing feature
...
//          initialize our output file
            Formatter fileOutput = new Formatter("resources/capitalVowels.txt");
...
/*                              if letter is encoded to a vowel then uppercase it else just return the usual encoded
                                value */
                                (vowels.contains(String.valueOf((char)((int)letter.charAt(0) + 15))) ?
                                        String.valueOf((char)((int)letter.charAt(0) + 15)).toUpperCase() :
                                            String.valueOf((char)((int)letter.charAt(0) + 15))) :
...
/*                              if letter is encoded to a vowel then uppercase it else just return the usual encoded
                                value */
                                (vowels.contains(String.valueOf((char)((int)letter.charAt(0) - 11))) ?
                                        String.valueOf((char)((int)letter.charAt(0) - 11)).toUpperCase() :
                                            String.valueOf((char)((int)letter.charAt(0) - 11))) : letter).collect(Collectors.toList());
